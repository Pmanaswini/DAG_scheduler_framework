...
# #os.chdir('home/manaswani/Binning/Enhanced_Sawtooth/validator')
...
# os.chdir(parent_dir)
# #print(parent_dir)
# #os.chdir('home/manaswani/Binning/Enhanced_Sawtooth/pyclient')
...
# with open("DS_computation.txt", "a") as file:
#     value=0
#     for line in file:
...
#     value=0
#     for line in file:
#         if line.startswith("Serial Binning:"):
#             value = float(line.split(":")[1])
#             DS_LL += value
...
# if DS_MBPS>0:
#     print("MBPS verification time:", DS_MBPS)
